...
(cover page, tables, badges, wrapped narrative text) while keeping the Fortinet
scanner's zero-external-dependency guarantee (important for offline / OT use).

Coordinate system is PDF-native: origin bottom-left, Y grows upward. The report
layer (`fortinet_pdf.py`) works top-down and converts.
"""
